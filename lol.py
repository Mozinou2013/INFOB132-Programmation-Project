...
def play_game(map_path, group_1, type_1, group_2, type_2):
    ...
    while player_1[alpha1]['life'] > 0 and player_2[alpha2]['life'] > 0 and i <= 200:
        ...
        for wolves in player_1:
            live += player_1[wolves]['life']
        for wolves in player_2 :
            life += player_2[wolves]['life']
        life_final = live + life
        ...
        for wolves in player_1:
            livee += player_1[wolves]['life']
        for wolves in player_2 :
            lifee += player_2[wolves]['life']

        life_finall = livee + lifee

        if life_finall == life_final:
            i += 1
        else:
            i = 0
